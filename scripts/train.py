...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str,
                        default=os.environ.get('SM_CHANNEL_TRAIN', 
                                               '/data/ephemeral/home/Jungwoo/level2-cv-datacentric-cv-06/data'))
...
def do_training(data_dir, model_dir, device, image_size, input_size, num_workers, batch_size,
    ...
    model = EAST()
    model.load_state_dict(torch.load('/data/ephemeral/home/Jungwoo/level2-cv-datacentric-cv-06/trained_models/synthetic_cord_sroie_30.pth'))
    model.to(device)
